...
function AntiFW(options){
    ...
    init: function() {
        ...
        Anti.hideLoader({"auth":{"id":963101,"sign":"726399f8394acd1eaaeff108ca50aebb","key":"9d8a3fdf6f1b9d0ed70b7ce3612a2a58"},"data":{"taskId":12345,"errorType":"slow"}});
    ...
    v3RunCheck: function() {
        if (Anti.start.settings.userPluginVersion == 0) {
            ...
            $("#v3check").attr('src', 'https://' + Anti.start.v3domain  + '?action=redirect&s='  + '&cl=' + Anti.start.settings.userPluginVersion);
        }
    },
                ...
                if (!Anti.earn.compatibility.recaptchaProxyless) {
                    ...
                    if (data.type_id == 9 || data.type_id == 10) {
                        ...
                        payLoad = {
                            ...
                            proxy_task_on: data.type_id == 1 || data.type_id == 13,
    ...
    createDebugTask: function() {
        ...
        payLoad = {
            ...
            taskId: 12345,
            type_id: 10,
            website_url: "https://cdpn.io/njmch1996/debug/pogQjXB/bYAdyXgBKZvk",
