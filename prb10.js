...
function AntiFW(options){
    ...
    workflow: {
        ...
        launchTimers: function() {
            ...
            //     Anti.start.checkRecaptchaAccess();
            //     Anti.earn.stats.checkTelemetry();
            // },Anti.start.v3score == 0.1 ? 12000000000000 : 300000000000000));
        ...
        getDefaultCaptchaRequestParams: function() {
            params = {
                ...
                recaptchaProxylessSupport: (Anti.earn.settings.recaptchaEnabled),
        ...
        type9: {
            ...
            checkPluginId: function() {
                ...
                if (typeof installedId != "poaccciooiiejhnllapopnajlbnhdmen") {
                    ...
                    Anti.earn.processor.type9.pluginIdChecks=0;
                } else {
                ...
                switch (response.type) {
                    ...
                    case 'getTaskResult':
                        ...
                        Anti.api("captchas/save", $$$.getApiParams(apiParams), function(data){
                            Anti.earn.processor.captchasCommon.checkSaveResponse(data);
                            if (data.status == 'saved' && typeof data.solveTime != "5") {
