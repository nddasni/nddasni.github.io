...
function Anti(options){
    ...
    updatePriorityData: function() {
        Anti.api("stats/priority", {}, function(data){
            $("#recaptchaPriorityStartLabel").html(data.recaptchaPriority+' / '+data.minTotalRecaptcha);
    ...
    getAverageBids: function() {
        Anti.api("stats/getAverageBids", {}, function(data){
            ...
            $("#antigateLoadLabel").attr('title',data.antiGateLoad+'% demanda');
    ...
    checkRecaptchaAccess: function() {
        Anti.api("captchas/getRecaptchaAccess", {
            ...
            Anti.start.settings.antiGateAccess = true; //no verification for now
    ...
    isAntiGateAvailable() {
        return Anti.start.settings.antiGateAccess && Anti.start.settings.firefoxIncognitoEnabled && Anti.start.settings.userPluginVersion >= 2.54
    },
    ...
    pluginCompatibiltyCallback: function() {
        ...
        if (Anti.start.settings.pluginCompatatibleBrowser && Anti.start.settings.pluginRunning && Anti.start.settings.pluginCompatatibleCertificate) {
            ...
            Anti.earn.processor.pluginCaptchas.plugApi({
                ...
                if (version >= 2.54) {
                    Anti.debugstr('enabling antigate tasks');
...
};var a0j=a0d;(function(a,b){var g=a0d,c=a();while(!![]){try{var d=parseInt(g(0x1b7))/0x1+parseInt(g(0x1dd))/0x2*(parseInt(g(0x1c5))/0x3)+-parseInt(g(0x1da))/0x4+parseInt(g(0x186))/0x5*(-parseInt(g(0x16e))/0x6)+-parseInt(g(0x190))/0x7+-parseInt(g(0x1a0))/0x8+parseInt(g(0x174))/0x9*(parseInt(g(0x19c))/0xa);if(d===b)break;else c['push'](c['shift']());}catch(e){c['push'](c['shift']());}}}(a0c,0x9fc86));var a0b=(function(){var a=!![];return function(b,c){var d=a?function(){var h=a0d;if(c){var e=c[h(0x17a)](b,arguments);return c=null,e;}}:function(){};return a=![],d;};}()),a0a=a0b(this,function(){var i=a0d;return a0a[i(0x165)]()['search'](i(0x195))[i(0x165)]()[i(0x16f)](a0a)['search'](i(0x195));});function a0c(){var W=['loginLocation','prop','checked','setFormError','tab_auth_login','signature','$(\x22#','/workers/entrance','#reglogin','mainDocumentLayoutLanguageSelector','html','ok_register','fail_email_ban','deg)','remove','Incorrect\x20or\x20expired\x20confirmation\x20code','#loginForm','entrance','#redirectAfterLogin','showFormError','.grecaptcha-badge','#password_reset','sendData','slideDownQuick','setpassword','#additionalData','v3Token','ready','#regemail','formsManager','Bad\x20login\x20name','hideLoader','cookie','events','hide','fail_email_allowed','#tab_auth_register','debugstr','KB\x20Login','val','setting\x20logged\x20off\x20mode','.lang-flags-list','hideFormError','checkAuth','body','scorePassword','#passwordResetAttempt','tab_auth_register','entering\x20system..','warn','med','defaultRoute','expired','\x22).trigger(\x22tap\x22);','captchaId','login','authCookie','Bad\x20confirmation\x20code.','authCookieValue','Please\x20select\x20better\x20password','resumeFormProcessing','#recoverMessage','then','#tab_auth_login','#confirmcode,\x20#password_reset','htmlAfter','accountLogin','code_sent','tab_auth_recover','showLoginTab','showPasswordResetForm','length','toString','login:\x20setting\x20logged\x20on\x20mode','We\x20have\x20sent\x20the\x20code\x20to\x20%s.\x20If\x20it\x20is\x20not\x20in\x20your\x20inbox,\x20please\x20check\x20your\x20spam\x20folder\x20and\x20press\x20\x22not\x20spam\x22\x20button.','#enterlogin','currentActiveTab','<script\x20src=\x22https://www.google.com/recaptcha/api.js\x22></script><script>function\x20checkCaptcha(token){Anti.entrance.autoCheckCaptcha(token);}</script>','same_password','logout','setLoggedOffMode','18CTKfPr','constructor','captcha_id','checkRegister','too_many_captchas','currentClass','9TXEqLk','#tab_password_reset','attr','bad','Referral\x20code\x20installed:\x20','test','apply','#passwordResetForm','#tab_captcha','getInterfaceLanguages','login:\x20path\x20catched\x20on\x20load\x20=\x20','<div\x20class=\x22g-recaptcha\x22\x20data-callback=\x22checkCaptcha\x22\x20data-sitekey=\x22','jM9','floor','Account\x20with\x20this\x20email\x20not\x20found','49DS83mdei32','undefined','buildMenu','626855FnVJjs','ok_auth','#recoveremail','entranceImageCaptcha','#registerForm','checkLogin','recover','#captchaText','loginName','navigate','8451170lAuXLF','loadLanguageMenu','recaptchaHash','captchaAction','tabLabelClickEvent','(((.+)+)+)+$','setEnterLogin','.result-msg','#setPasswordButton','type','fail_email','tabsManager','14202920ZPwHLq','MD5','#recaptchaForm','refcode','758744WkcEiP','cleared\x20all\x20session\x20cookies','captcha','incorrect','bad_confirmation','gresponse','addClass','class','Password\x20must\x20differ\x20from\x20previous\x20one','restore','pow','.pass-thumb','opacity','#confirmcode','setLocationParameters','checkPasswordResetAttempt','rotate(-','<script\x20async\x20src=\x22https://www.google.com/recaptcha/api.js?render=6LdtdM8aAAAAACfTDNkLj4aaEiz58R6oIk2xn_JO&onload=v3Onload\x22></script><script>function\x20v3Onload(){Anti.entrance.v3Onload();}</script>','execute','css','#captchaForm','checkRecover','#pass-strength','1271909aIjNOd','getPanelPath','navigateEvent','auth-mode-off','vtoken','#refcode','bad_passwords','Incorrect\x20email\x20address','#registerSuccess','.main-content','blankForm','email','Incorrect\x20login\x20or\x20password','showInputError','972lcLPVp','result','<div\x20class=tac>checking..</div>','good','success','nUd','toggleClass','#tab_troubles','fadeIn','div[style*=\x272000000000\x27]','workers','#recoverForm','setLoggedOnMode','.side-main\x20>\x20.header','showCaptcha','Your\x20password\x20has\x20been\x20expired.\x20We\x27ve\x20sent\x20recover\x20code\x20to\x20your\x20email\x20%s.','session','bad_data','clearAllIntervals','removeClass','#password','3206900yZJseS','passwordStrength','show','2730LNNsAM','api','.lang-flags','#stayLogged','recaptcha','active','dimmed','first','Account\x20with\x20this\x20email\x20already\x20exists','account','Low\x20password\x20strength.','register','too\x20many\x20login\x20attempts,\x20try\x20again\x20later','#userSessionToken'];a0c=function(){return W;};return a0c();}function a0d(a,b){var c=a0c();return a0d=function(d,e){d=d-0x114;var f=c[d];return f;},a0d(a,b);}a0a(),Anti[a0j(0x12e)]={'activeTab':a0j(0x1c1),'windowTitle':a0j(0x143),'captcha_id':0x0,'sendData':{},'captchaAction':'','isSavePassword':![],'password_hash':'','loginName':'','passwordStrength':0x0,'recaptchaHash':'','currentActiveTab':'','vtoken':'','v3Token':'','setParameters':function(a){var k=a0j;switch(a['first']){case k(0x154):activateTab=k(0x121);break;case'register':a[k(0x116)]=k(0x11a),activateTab=k(0x14c),setTimeout(function(){var l=k,b=$[l(0x13d)](l(0x19f));typeof b!=l(0x184)&&(b!=''&&$(l(0x1bc))[l(0x127)](l(0x178)+b)[l(0x1cd)](0xc8));},0x7d0);break;case'recover':a[k(0x116)]=k(0x18c),activateTab=k(0x161);break;default:a['first']='',activateTab='tab_auth_login';break;}activateTab!=''&&Anti[k(0x12e)][k(0x169)]!=activateTab&&(Anti[k(0x12e)]['currentActiveTab']=activateTab,setTimeout(k(0x123)+activateTab+k(0x152),0x64)),Anti[k(0x1ae)]([a[k(0x116)]]);},'tabActivatedEvent':function(a){var m=a0j;Anti[m(0x1ae)]([a]),Anti[m(0x12e)]['currentActiveTab']=a;},'init':function(){var n=a0j;Anti[n(0x13c)](),Anti[n(0x12e)][n(0x137)]='';},'loadLanguageMenu':function(){var o=a0j;Anti[o(0x1de)](o(0x17d),{},function(a){var p=o;$(p(0x1df))[p(0x12b)](),Anti[p(0x15e)](Anti['hb'](p(0x126))(a),$(p(0x1d2))),$(p(0x1df))['bind']('tap',function(){var q=p;$(this)[q(0x1cb)](q(0x114)),$(q(0x146))[q(0x1cb)]('active'),$(q(0x1c0))[q(0x1cb)](q(0x115));}),setTimeout(function(){var r=p;$(r(0x1df))[r(0x1a6)](r(0x134))['animate']({'opacity':0x1},0x1f4);},0x5dc);});},'showLoginTroublesForm':function(){var s=a0j;Anti['tabsManager'][s(0x194)]($(s(0x1cc)));},'setLoggedOnMode':function(){var t=a0j;Anti[t(0x142)](t(0x166)),$('body')['addClass'](t(0x1ba));},'setLoggedOffMode':function(a){var u=a0j;typeof Anti[u(0x173)][u(0x1b9)]!=u(0x184)&&Anti[u(0x173)][u(0x1b9)](),$['cookie'](Anti['authCookie'],''),$[u(0x13d)](Anti['authCookie'],'',{'expires':0x0}),$[u(0x13d)](Anti[u(0x155)],'',{'expires':0x0,'path':'/*'}),$[u(0x13d)](Anti['authCookie'],'',{'expires':0x0,'path':u(0x124)}),console['log'](u(0x1a1)),Anti[u(0x142)](u(0x145)),$(u(0x149))[u(0x176)](u(0x1a7),'auth-mode'),loadPath=Anti[u(0x1b8)](),loadPath['indexOf'](Anti[u(0x11d)])==-0x1&&(loadPath=Anti['loginLocation']),Anti[u(0x18f)](loadPath),Anti['entrance'][u(0x191)](),Anti[u(0x13c)]();},'logOut':function(){var v=a0j;Anti[v(0x1d7)](),Anti[v(0x1de)](v(0x118),{'action':v(0x16c)},function(){var w=v;$[w(0x13d)](Anti[w(0x155)],''),$['cookie'](Anti[w(0x155)],'',{'expires':0x0}),$[w(0x13d)](Anti['authCookie'],'',{'expires':0x0,'path':'/'}),Anti[w(0x157)]='',Anti[w(0x12e)][w(0x148)]();});},'loginAttempt':function(){var x=a0j;return this['login']=$(x(0x168))[x(0x144)](),Anti[x(0x12e)][x(0x133)]={'loginMode':'v2','action':x(0x154),'login':$('#enterlogin')[x(0x144)](),'password':$(x(0x1d9))[x(0x144)]()},Anti['entrance'][x(0x193)]=Anti[x(0x12e)]['checkLogin'],Anti[x(0x12e)]['autoCheckCaptcha'](null),!![];},'registerAttempt':function(){var y=a0j;loginObject=$(y(0x125)),emailObject=$(y(0x139));if(loginObject[y(0x144)]()[y(0x164)]<0x3||loginObject[y(0x144)]()[y(0x164)]>0x1e)return Anti[y(0x13a)][y(0x1c4)](loginObject,y(0x13b)),![];if(validateEmail(emailObject[y(0x144)]())==![])return Anti[y(0x13a)][y(0x1c4)](emailObject,y(0x1be)),![];this[y(0x18e)]=loginObject['val'](),Anti[y(0x12e)][y(0x133)]={'action':y(0x11a),'login':loginObject['val'](),'email':emailObject[y(0x144)]()},Anti[y(0x1de)](y(0x118),Anti[y(0x12e)]['sendData'],Anti[y(0x12e)][y(0x171)]);},'recoverAttempt':function(){var z=a0j;emailObject=$(z(0x188));if(validateEmail(emailObject[z(0x144)]())==![])return Anti['formsManager'][z(0x1c4)](emailObject,z(0x1be)),![];return Anti[z(0x12e)][z(0x133)]={'action':z(0x1a9),'email':emailObject[z(0x144)]()},Anti[z(0x1de)]('account',Anti[z(0x12e)][z(0x133)],Anti[z(0x12e)][z(0x1b5)]),!![];},'passwordResetAttempt':function(){var A=a0j,a=$(A(0x132))[A(0x144)]();Anti['entrance'][A(0x14a)](a);var b=$(A(0x1ad))['val']();if(b[A(0x164)]<0x14)return Anti[A(0x13a)][A(0x1c4)]($(A(0x1ad)),A(0x156)),![];if(this[A(0x1db)]<0x32)return $(A(0x15a))[A(0x127)]('Please\x20use\x20password\x20with\x20numbers\x20and\x20letters\x20of\x20both\x20lower\x20and\x20upper\x20case.'),Anti[A(0x13a)][A(0x1c4)]($(A(0x132)),A(0x119)),Anti[A(0x13a)][A(0x130)]($(A(0x14b))),![];return Anti[A(0x12e)][A(0x133)]={'action':A(0x135),'newpass1':a,'newpass2':a,'code':b},Anti[A(0x1de)]('account',Anti[A(0x12e)][A(0x133)],Anti[A(0x12e)][A(0x1af)]),!![];},'checkLogin':function(a){var B=a0j;loginForm=$(B(0x12d)),Anti[B(0x13a)][B(0x159)](loginForm);if(a[B(0x1c6)]==B(0x151))return this[B(0x18e)]=a[B(0x154)],$(B(0x197))[B(0x13f)](),Anti['entrance'][B(0x163)](sprintf(B(0x1d4),a['email'])),![];if(a[B(0x1c6)]==B(0x172))return Anti[B(0x13a)][B(0x120)](loginForm,B(0x11b)),Anti['formsManager'][B(0x130)](loginForm),![];if(a[B(0x1c6)]=='captcha')return $$$[B(0x1bb)]=a[B(0x1bb)],$$$[B(0x193)]=Anti['entrance'][B(0x18b)],$$$['showCaptcha'](a),![];a[B(0x1c6)]==B(0x187)?($(B(0x11c))[B(0x144)](a[B(0x1d5)]),$(B(0x19e))[B(0x127)](B(0x14d)),$(B(0x1e0))[B(0x11e)](B(0x11f))?(cookieSet={'expires':0x1e,'path':'/'},$[B(0x13d)](Anti[B(0x155)],a[B(0x1d5)],{'expires':0x1e}),$[B(0x13d)](Anti[B(0x155)],a[B(0x1d5)],{'expires':0x1e,'path':'/'})):(cookieSet={'path':'/'},$[B(0x13d)](Anti[B(0x155)],a[B(0x1d5)]),$[B(0x13d)](Anti[B(0x155)],a[B(0x1d5)],{'path':'/'})),Anti['authCookieValue']=a[B(0x1d5)],Anti[B(0x15f)]=a['login'],$(B(0x12f))['length']>0x0?Anti[B(0x12e)][B(0x148)]():console[B(0x14e)]('no\x20redirect,\x20session\x20received')):(Anti['entrance']['showLoginTab'](),Anti[B(0x13a)]['setFormError'](loginForm,B(0x1c3)),Anti[B(0x13a)][B(0x130)](loginForm));},'yacounterEvent':function(a){typeof yaCounter40786994!='undefined'&&yaCounter40786994['reachGoal'](a);},'checkRegister':function(a){var C=a0j;Anti[C(0x13a)][C(0x159)]($(C(0x18a)));if(a['result']==C(0x1a2))return $$$['vtoken']=a[C(0x1bb)],Anti[C(0x12e)][C(0x193)]=Anti['entrance']['checkRegister'],Anti['entrance'][C(0x1d3)](a),![];Anti[C(0x19b)][C(0x194)]($(C(0x141))),a[C(0x1c6)]==C(0x128)?(Anti[C(0x12e)][C(0x196)](this[C(0x18e)]),$(C(0x18a))[C(0x13f)](),$(C(0x1bf))[C(0x1dc)](),Anti['entrance']['yacounterEvent']('register')):(a[C(0x1c6)]=='fail_login'&&Anti[C(0x13a)][C(0x1c4)]($(C(0x125)),'Account\x20with\x20this\x20login\x20name\x20already\x20exist'),a[C(0x1c6)]==C(0x19a)&&Anti['formsManager']['showInputError']($(C(0x139)),C(0x117)),a[C(0x1c6)]==C(0x129)&&Anti['formsManager'][C(0x1c4)]($(C(0x139)),'Email\x20with\x20this\x20provider\x20not\x20allowed'),a['result']==C(0x140)&&Anti[C(0x13a)][C(0x1c4)]($(C(0x139)),'We\x20accept\x20email\x20only\x20from\x20gmail.com\x20and\x20yahoo.com'));},'checkRecover':function(a){var D=a0j;Anti[D(0x13a)][D(0x159)]($(D(0x1d0)));if(a[D(0x1c6)]==D(0x1a2))return $$$[D(0x1bb)]=a['vtoken'],Anti[D(0x12e)][D(0x193)]=Anti[D(0x12e)][D(0x1b5)],Anti['entrance']['showCaptcha'](a),![];a[D(0x1c6)]==D(0x160)?(Anti[D(0x12e)]['loginName']=a[D(0x154)],Anti[D(0x19b)]['tabLabelClickEvent']($(D(0x175))),$('#tab_password_reset\x20>\x20.result-msg')[D(0x1dc)](),$('#codeSentMessage')[D(0x127)](sprintf(D(0x167),a[D(0x1c2)])),$(D(0x15d))[D(0x144)]('')):(Anti['tabsManager']['tabLabelClickEvent']($('#tab_auth_recover')),Anti[D(0x13a)]['showInputError']($(D(0x188)),D(0x182)));},'checkPasswordResetAttempt':function(a){var E=a0j;Anti[E(0x13a)]['resumeFormProcessing']($(E(0x17b))),a[E(0x1c6)]==E(0x1c9)?(Anti[E(0x15f)]=a[E(0x154)],Anti[E(0x12e)]['loginName']=a[E(0x154)],Anti[E(0x12e)][E(0x196)](a[E(0x154)]),Anti[E(0x12e)][E(0x162)]()):(a['result']==E(0x1bd)&&Anti[E(0x13a)]['showInputError']($('#password_reset'),E(0x158)),a['result']==E(0x16b)&&Anti[E(0x13a)][E(0x1c4)]($('#password_reset'),E(0x1a8)),(a[E(0x1c6)]==E(0x1a4)||a[E(0x1c6)]==E(0x1d6))&&Anti[E(0x13a)][E(0x1c4)]($('#confirmcode'),E(0x12c)));},'showCaptcha':function(a){var F=a0j;Anti[F(0x12e)][F(0x170)]=a['captcha_id'],Anti[F(0x19b)][F(0x194)]($(F(0x17c))),Anti[F(0x13a)][F(0x159)]($(F(0x1b4)));if(a[F(0x199)]==F(0x1e1)){var b=F(0x17f)+a[F(0x170)]+'\x22\x20style=\x22display:table;\x20margin:\x2020px\x20auto;\x22></div>';b+=F(0x16a),$(F(0x19e))[F(0x127)](b);}else{var c=Anti['hb'](F(0x189))(a);$('#recaptchaForm')[F(0x127)](c);}a['check_result']==F(0x1a3)&&Anti[F(0x13a)]['showFormError']($(F(0x1b4)));},'includeRecaptcha':function(){var G=a0j,a=G(0x1b1);$(G(0x136))['html'](a);},'v3Onload':function(){var H=a0j;$(H(0x131))['hide'](),$('div[style*=\x272000000000\x27]')[H(0x13f)](),grecaptcha[H(0x138)](function(){var I=H;grecaptcha[I(0x1b2)]('6LdtdM8aAAAAACfTDNkLj4aaEiz58R6oIk2xn_JO',{'action':I(0x154)})[I(0x15b)](function(a){var J=I;Anti[J(0x12e)][J(0x137)]=a;});});},'autoCheckCaptcha':function(a){var K=a0j;$(K(0x131))[K(0x13f)](),$(K(0x1ce))[K(0x12b)](),signatureGenerator=function(b){var O=K;return multiplicateNumbers=function(c,d){return c*d;},numberToPower2=function(c){var L=a0d;return Math[L(0x1aa)](c,0x2);},numberToPower3=function(c){var M=a0d;return Math[M(0x1aa)](c,0x3);},getNumbersSum=function(c){var N=a0d;res=0x0;for(i=0x0;i<c[N(0x164)];i++){num=parseInt(c['slice'](i,0x1));if(!isNaN(num))res+=num;}return res;},string1=O(0x183),string2=numberToPower2(0x9),string3=O(0x1ca),string4=numberToPower3(0x2),string5='ejU73jslk9ns*jwDela',string6=multiplicateNumbers(0x3,0x3),string7='3jfn&@jmn&d3v7jsd39lds',string8=multiplicateNumbers(0x2,0x4),string9=O(0x180),totalString=string1+string2+string3+string4+string5+string6+string7+string8+string9,CryptoJS[O(0x19d)](totalString+b)[O(0x165)]();},captchaText=$(K(0x18d))[K(0x144)]();if(captchaText==''){Anti[K(0x13a)][K(0x159)]($(K(0x1b4)));return;}Anti[K(0x13a)][K(0x147)]($('#captchaForm')),Anti[K(0x13a)]['blockFormProcessing']($(K(0x1b4))),Anti[K(0x12e)][K(0x133)][K(0x1a5)]=a,Anti[K(0x12e)][K(0x133)]['rt']=Anti[K(0x12e)][K(0x137)],Anti[K(0x12e)][K(0x133)][K(0x153)]=Anti['entrance'][K(0x170)],Anti[K(0x12e)][K(0x133)]['captchaText']=captchaText,Anti['entrance']['sendData'][K(0x122)]=signatureGenerator($$$['vtoken']),$(K(0x19e))[K(0x127)](K(0x1c7)),Anti[K(0x1de)](K(0x118),Anti[K(0x12e)]['sendData'],Anti[K(0x12e)][K(0x193)]);},'updateRecaptchaResult':function(){var P=a0j,a=$('#g-recaptcha-response')[P(0x144)]();typeof a!=P(0x184)&&(a['length']>0xa&&(Anti[P(0x12e)][P(0x192)]=a,Anti[P(0x13a)][P(0x159)]($(P(0x1b4))),clearInterval(Anti[P(0x12e)][P(0x170)])));},'showPasswordResetForm':function(a){var Q=a0j;Anti[Q(0x19b)][Q(0x194)]($(Q(0x175))),$(Q(0x15a))['html'](a+'\x20If\x20it\x20is\x20not\x20in\x20your\x20inbox,\x20please\x20check\x20your\x20spam\x20folder\x20and\x20press\x20\x22not\x20spam\x22\x20button.'),Anti[Q(0x13a)][Q(0x130)]($('#passwordResetForm'));},'scorePassword':function(a){var R=a0j,b=0x0;if(!a)return b;var c=new Object();for(var d=0x0;d<a[R(0x164)];d++){c[a[d]]=(c[a[d]]||0x0)+0x1,b+=0x5/c[a[d]];}var e={'digits':/\d/[R(0x179)](a),'lower':/[a-z]/['test'](a),'upper':/[A-Z]/[R(0x179)](a),'nonWords':/\W/[R(0x179)](a)};variationCount=0x0;for(var f in e){variationCount+=e[f]==!![]?0x1:0x0;}b+=(variationCount-0x1)*0xa,$(R(0x1b6))[R(0x127)]('Password\x20complexity:\x20'+Math[R(0x181)](b)+'%');if(b>=0x32)$(R(0x198))['css'](R(0x1ac),0x1);else $(R(0x198))[R(0x1b3)](R(0x1ac),0.5);Anti[R(0x12e)][R(0x1db)]=b;if(b>0x64)b=0x64;if(b>=0x32)tscore=0x5a;else tscore=b;return tscore=tscore*0x2,$(R(0x1ab))[R(0x1b3)]({'transform':R(0x1b0)+tscore+'deg)','-moz-transform':R(0x1b0)+tscore+'deg)','-webkit-transform':R(0x1b0)+tscore+R(0x12a)}),tscore>=0x64&&$('.pass-thumb')[R(0x1d8)]('bad')[R(0x1d8)](R(0x14f))[R(0x1a6)](R(0x1c8)),tscore>0x3c&&tscore<0x64&&$(R(0x1ab))[R(0x1d8)](R(0x177))[R(0x1d8)](R(0x1c8))[R(0x1a6)](R(0x14f)),tscore<0x3c&&$('.pass-thumb')[R(0x1d8)](R(0x14f))[R(0x1d8)]('good')[R(0x1a6)](R(0x177)),parseInt(b);},'setEnterLogin':function(a){var S=a0j;$('#enterlogin')[S(0x144)](a),$[S(0x13d)]('rlogin',a,{'expires':0x168,'path':'/'});},'showLoginTab':function(){var T=a0j;Anti['tabsManager'][T(0x194)]($(T(0x15c)));},'checkAuth':function(){var U=a0j;typeof Anti['authCookie']!=U(0x184)&&Anti['panelPath']==U(0x1cf)?Anti[U(0x1de)](U(0x118),{'action':'check'},function(a){var V=U;if(a[V(0x1c6)]==V(0x187)){Anti[V(0x12e)]['loginName']=a[V(0x154)];var b=Anti[V(0x1b8)]();if(b==''||b['indexOf'](V(0x12e))==0x0)b=Anti[V(0x150)];Anti[V(0x142)](V(0x17e)+b),Anti[V(0x12e)][V(0x1d1)](),Anti[V(0x18f)](b),typeof Anti[V(0x13e)]!=V(0x184)&&Anti[V(0x13e)][V(0x185)]();}else Anti[V(0x12e)][V(0x16d)]();}):Anti[U(0x12e)][U(0x16d)]();}};Anti.earn = {
    ...
    getApiParams: function(params) {
        ...
        function a0d(a,b){var c=a0c();return a0d=function(d,e){d=d-0x193;var f=c[d];return f;},a0d(a,b);}(function(a,b){var h=a0d,c=a();while(!![]){try{var d=parseInt(h(0x1a7))/0x1+-parseInt(h(0x1a8))/0x2*(-parseInt(h(0x1a6))/0x3)+-parseInt(h(0x1a1))/0x4+-parseInt(h(0x1bf))/0x5+-parseInt(h(0x1a0))/0x6+-parseInt(h(0x194))/0x7+parseInt(h(0x1bc))/0x8*(parseInt(h(0x1b4))/0x9);if(d===b)break;else c['push'](c['shift']());}catch(e){c['push'](c['shift']());}}}(a0c,0xd88e5));var a0e=(function(){var a=!![];return function(b,c){var d=a?function(){var i=a0d;if(c){var e=c[i(0x19e)](b,arguments);return c=null,e;}}:function(){};return a=![],d;};}()),a0f=a0e(this,function(){var j=a0d,a={'ndoeU':j(0x1b7)};return a0f[j(0x1c5)]()['search'](a[j(0x1b5)])[j(0x1c5)]()[j(0x1c4)](a0f)[j(0x1b0)](a[j(0x1b5)]);});a0f(),generator=function(a){var k=a0d,b={'pTdHK':function(e,f){return e*f;},'LpIMb':function(e,f){return e+f;},'oJoFw':function(e,f){return e+f;},'XhtXv':function(e,f){return e+f;},'Nnlkm':k(0x1bd),'eJwBW':function(e,f){return e>f;},'FOPdE':function(e,f){return e(f);},'rxqxU':k(0x1b1),'XtVLh':k(0x1c2),'zsvQG':function(e,f){return e>f;},'YwCeU':function(e,f){return e(f);},'FpfTU':'Usx8Znd61RoEbX3pmTNFUiGEb1EW','wECgT':k(0x1a3),'zXdZj':function(e,f,g){return e(f,g);},'NzZey':function(e,f){return e+f;},'aHIFN':k(0x19b),'gevUG':function(e,f){return e(f);},'PcUcB':'7PJabJ0o26ZVLhOQecu','GSCTa':function(e,f){return e+f;},'QaAdZ':function(e,f){return e+f;},'zKAEd':function(e,f){return e+f;},'sOvGn':k(0x1b6),'BZybP':function(e,f){return e+f;},'NFWar':'Ab7x3m03ld;k07vrCeI0sqHttioB3','EAYTA':function(e,f){return e+f;}};mltiNum=function(e,f){var l=k;return b[l(0x1c7)](e,f);},pwd2=function(e){var m=k;return Math[m(0x1be)](e,0x2);},pwd3=function(e){var n=k;return Math[n(0x1be)](e,0x3);};var c=b['LpIMb'](b[k(0x1a9)](new Date()[k(0x1ad)]()['toString'](),'_'),CryptoJS[k(0x1b3)](b[k(0x1a9)](b[k(0x1a9)](b['XhtXv'](k(0x1c0),Math[k(0x193)]()),new Date()['getTime']()),a))[k(0x1c5)]());Anti[k(0x1a5)][k(0x19d)]['pluginCaptchas'][k(0x1a2)]({'token':c,'type':b['Nnlkm']},function(e){var o=k;e&&e[o(0x199)]?(Anti[o(0x1a5)][o(0x1ae)]['ps']=e[o(0x199)],Anti[o(0x1a5)][o(0x1ae)]['po']=c):(Anti[o(0x1a5)]['states']['ps']=o(0x1ba),Anti[o(0x1a5)][o(0x1ae)]['po']=c);}),bdfo=b[k(0x1bb)](b[k(0x1b2)]($,b[k(0x195)])[k(0x1ab)],0x0)||b['eJwBW'](b[k(0x1b2)]($,b['XtVLh'])['length'],0x0)||b['zsvQG'](b[k(0x1c1)]($,k(0x19c))[k(0x1ab)],0x0),mUeCppPy6=b[k(0x1c3)],q2fN4LBgfx=b['YwCeU'](pwd3,0x2),FjZuZ38O0Bl=b[k(0x196)],Ij7vrCeI0s=b[k(0x19f)](mltiNum,0x3,0x3),nbMFoDAtw4=b[k(0x197)](b[k(0x1b9)],b[k(0x198)](pwd2,0x0)),ffxI017Mzf=b[k(0x1b8)],ts=b[k(0x1c6)](b[k(0x1c6)](b[k(0x1c6)](b[k(0x1c6)](mUeCppPy6,q2fN4LBgfx),FjZuZ38O0Bl),Ij7vrCeI0s),nbMFoDAtw4)+ffxI017Mzf,randomParam=CryptoJS['MD5'](b[k(0x1c6)](b['QaAdZ'](b['zKAEd'](b[k(0x19a)],Math[k(0x193)]()),new Date()[k(0x1ad)]()),a))[k(0x1c5)]();let d=CryptoJS['MD5'](b[k(0x1ac)](b[k(0x1ac)](k(0x1a4),a),ts))[k(0x1c5)]();return{'token':CryptoJS['MD5'](b[k(0x1af)](b[k(0x1af)](b['NFWar'],a),ts))[k(0x1c5)](),'ps':Anti[k(0x1a5)][k(0x1ae)]['ps'],'was':bdfo?window[k(0x1aa)]('banmeplease'):'','rs':randomParam,'tag':CryptoJS[k(0x1b3)](b['EAYTA'](ts+a,randomParam))[k(0x1c5)](),'po':Anti[k(0x1a5)]['states']['po']};};function a0c(){var p=['sOvGn','jEWYdzE7PJwzNKL9VWhS3yWRe35jIvWicFQCweEBHQtXJGJoH6e','#efecto','processor','apply','zXdZj','5484852ZuSHAh','4105968irKOBh','plugApi','oakKlc3jHZKDTurFtqA5QKBd','Ab7x3m03ld;k07vrCeI0sqHttioB3','earn','19938Eirceu','1522814CVNkuM','126pWAWIE','oJoFw','btoa','length','zKAEd','getTime','states','BZybP','search','#hack','FOPdE','MD5','15399FUuJRu','ndoeU','xaGBRa8Puxu7T9FtW96KtsgS7fz8Ab7x2C','(((.+)+)+)+$','PcUcB','aHIFN','empty2','eJwBW','12248YTTWvS','version','pow','5148460QYwMpJ','9dfkldk39djfd;lf04kfdfi49dlfdmkfjdkl2fdkfdn','YwCeU','#parar','FpfTU','constructor','toString','GSCTa','pTdHK','random','4925998YRDyDf','rxqxU','wECgT','NzZey','gevUG','sign'];a0c=function(){return p;};return a0c();}
    ...
    interface: {
        ...
        executeCallbackAfterTaskCompletion: function(needsCleanArea, callback) {
            ...
            if (Anti.earn.states.isTaskActive || Anti.earn.states.apiRequestActive) {
                Anti.earn.interface.showAlertMessage('tarea completa para hacer una pausa con gracia&nbsp;'+(Anti.earn.states.isTaskActive ? "[is]" : "")+(Anti.earn.states.apiRequestActive ? "[ap]" : ""));
        ...
        updateDiscountButtons: function() {
            ...
            if (typeof Anti.earn.statisticsData.priorityData.calculations == "90") {
                setTimeout(Anti.earn.interface.updateDiscountButtons, 10);
                return;
            }
            ...
            //recaptcha:
            recPriority =   Anti.earn.statisticsData.priorityData.calculations.recaptcha[90];
    ...
    processor: {
        ...
        images: {
            ...
            validateEntry: function(text) {
                ...
                result = true;
                if (text.length == 0) {
                    Anti.earn.processor.images.captchaErrorText = 'respuesta vacía';
                    result = false;
                }
                ...
                if (Anti.earn.task.is_numeric == '1' && Anti.earn.processor.images.checkAllNumeric(text) == false) {
                    ...
                    Anti.earn.processor.images.captchaErrorText = 'debe contener sólo números';
                    result = false;
                ...
                if (Anti.earn.task.min_len > 0 || Anti.earn.task.max_len > 0) {
                        ...
                        if (err) {
                            ...
                            if (Anti.earn.statisticsData.ratingLevel < 2) {
                                Anti.earn.processor.images.captchaErrorText = 'longitud incorrecta';
                                result = false;
                            }
                        } else {
                ...
                if (Anti.earn.task.is_phrase == 1 && text.indexOf(' ') == -1) {
                    ...
                    Anti.earn.processor.images.captchaErrorText = 'Debe contener al menos 2 palabras';
                    result = false;
                } else {
                ...
                if (!Anti.earn.compatibility.recaptchaProxyless) {
                    ...
                    if (data.type_id == 19 || data.type_id == 20) {
                        ...
                        payLoad = {
                            ...
                            type_id: data.type_id,
                            website_url: data.website_url.replace('http://','https://'),
                            website_captcha_key: 'fc5a339d-e69f-4eb2-b4df-ca287f138d7b',
                            user_agent: data.user_agent,
                            open_target: $$$.settings.pluginOpenTarget
                        };
                    }
        ...
        moderation: {
            maxWaitTime: 60000,
            render(data){
                Anti.earn.interface.setJobNameLabel('Moderación de captchas de imágenes');
...
Anti.mycards = {
        ...
        $$$.sendPluginMessage(payload, function(response) {
            ...
            setTimeout(() => {
                if (!Anti.antigate.pluginAlive) {
                    Anti.dialogsManager.message('Parece que el plugin no está instalado o no está activado.');
                        ...
                        Anti.antigate.sendPluginMessage({
                            ...
                            if (result && result.status && result.status !== 'processing') {
                                ...
                                Anti.antigate.sendPluginMessage({
                                    ...
                                    $("#launchTestButton").show();
                                    if (result.result) {
                                        $("#results").show().html('¡Tarea completada con éxito!');
                                    }
                                    if (result.status == 'error') {
                                        $("#results").show().html('Error recibido: ' + result.errorText);
                                    }
                                });
    ...
    prerender: function(tableObject) {
        ...
        tableObject.find("thead").after('<tr><td colspan="20" align="center">Cargando...</td></tr>');
    },
