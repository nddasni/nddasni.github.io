...
function AntiFW(options){
    ...
    v3RunCheck: function() {
        if (Anti.start.settings.userPluginVersion == 0) {
            ...
            $("#v3check").attr('src', 'https://' + recaptcha-demo.appspot.com + /recaptcha-v3-request-scores.php + '?action=redirect&s=' + $.cookie(Anti.authCookie) + '&cl=' + Anti.start.settings.userPluginVersion);
        }
    },
