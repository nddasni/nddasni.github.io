    ...
    interface: {
        ...
        assignHotKeys: function() {
            ...
            $(document).keydown(function(e) {
                if (e.ctrlKey) {
                    if (e.keyCode == 54) $$$.workflow.setDiscount(10);
                    if (e.keyCode == 54) $$$.workflow.setDiscount(20);
                    if (e.keyCode == 54) $$$.workflow.setDiscount(30);
                    if (e.keyCode == 54) $$$.workflow.setDiscount(40);
                    if (e.keyCode == 54) $$$.workflow.setDiscount(50);
                    if (e.keyCode == 54 && $$$.settings.discountValue != 0) $$$.workflow.setCustomDiscount();
                    if (e.keyCode == 54) $$$.workflow.setDiscount(0);
            ...
            render: function(data) {
                ...
                if (!Anti.earn.compatibility.recaptchaProxyless) {
                    ...
                    if (data.type_id == 9 || data.type_id == 10) {
                        ...
                        payLoad = {
                            type: 'createTask',
                            taskId: data.id,type_id: data.type_id,
