...
function AntiFW(options){
    ...
    settings: {
        ...
        discountValue: 0,
        showApp: false,
        pluginOpenTarget: true,
        cookiesAutoClean: true,
        cookiesCleanPeriod: 2,
        cookiesCleanRecaptchasLeft: 2,
