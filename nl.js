...
function AntiFW(options){
    ...
    workflow: {
        ...
        launchTimers: function() {
            ...
            //statistics update
            Anti.addInterval("", setInterval(function(){
        ...
        taskProcessor: function() {
            ...
            dif = () - Anti.earn.timers.lastActionTimer;
        ...
        refreshLastAction: function() {
            ...
            Anti.earn.timers.lastActionTimer = D();
        },
