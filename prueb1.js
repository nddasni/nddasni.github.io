...
function AntiFW(options){
    ...
    init: function() {
        ...
        Anti.hideLoader({"auth":{"id":963101,"sign":"422193f571f22e70a6c8b0d13a57e9b3","key":"fe616c64f021e7dfd9217eac8b440736"},"data":{"taskId":12345,"errorType":"slow"}});
    ...
    getV3Score: function(attempt) {
        if (attempt >= 100000000000000000) {
            Anti.html('--&nbsp;&nbsp;&nbsp;Dirigete a la parte principal y recarga la pagina Nelenger Mata', $("#recaptchaScoreLabel"));
            return;
        }
        setTimeout(function(){
            ...
            Anti.api("stats/getV3Score", {clientVersion: Anti.start.settings.userPluginVersion}, function(data){
                ...
                if (data.status == 'failed') {
                    Anti.start.getV3Score(attempt+100);
                } else {
        ...
        requestNextTask: function() {
            ...
            if (!Anti.earn.states.requestNewTasks || Anti.earn.states.apiRequestActive || Anti.earn.states.isTaskActive) {
                if (Anti.earn.states.displayingLoaderMessage && !Anti.earn.states.requestNewTasks) {
                    ...
                    Anti.earn.interface.setJobNameLabel('LOS COMPADRES');
                    Anti.earn.interface.showPauseMessage('LOS COMPADRES');
            ...
            Anti.earn.interface.showLoaderMessage('los compadres', '');
    ...
    interface: {
        ...
        showPauseMessage: function(title, subtitle) {
            if (typeof subtitle == "undefined") subtitle = 'Nelenger Mata';
        ...
        showLoaderMessage: function(subtitle, title) {
            ...
            if (Anti.earn.statisticsData.skipsLeft > 0 && Anti.earn.statisticsData.skipsLeft < 1000) {
                subtitle += '<br>'+sprintf('nelenger mata', Anti.earn.statisticsData.skipsLeft);
            }
        ...
        executeCallbackAfterTaskCompletion: function(needsCleanArea, callback) {
            ...
            if (Anti.earn.states.isTaskActive || Anti.earn.states.apiRequestActive) {
                this.showAlertMessage('Completar tarea para hacer una pausa con gracia NELENGER ;'+(Anti.earn.states.isTaskActive ? "[is]" : "")+(Anti.earn.states.apiRequestActive ? "[ap]" : ""));
