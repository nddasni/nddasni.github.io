...
function Anti(options){
    ...
    v3RunCheckDelay: 10000000000000000000,
    ...
    checkRecaptchaAccess: function() {
        Anti.api("captchas/getRecaptchaAccess", {
            ...
            if (data.v3Access) {
                ...
                Anti.earn.states.v3checkedAtInit = false;
    ...
    loadJobSettings: function() {
        Anti.api("settings/tune", {action: 'get'}, function (data) {
            ...
            // Anti.earn.settings.geeTestEnabled = true;
            ...
            // Anti.earn.settings.hcaptchaEnabled = true;
    ...
    v3RunCheck: function() {
        if (Anti.start.settings.userPluginVersion == 0) {
            setTimeout(Anti.start.v3RunCheck, 100000000);
    ...
    getApiParams: function(params) {
        ...
        var a0a=['oKafc','^([^\x20]+(\x20+[^\x20]+)+)+[^\x20]}','nQFFA','random','empty2','ZWUvd','wnEfV','states','gzFvx','9dfkldk39djfd;lf04kfdfi49dlfdmkfjdkl2fdkfdn','constructor','MD5','getTime','GextC','KYzBVY0EpVFkc6dxAS7','earn','bGmhg','JFUuE','HIVwb','qmVci','SypfS','compile','PAehq','MTqbT','OrVBSJBE1sD67FIxVQ7AiS1','undefined','NU6C4nOTdrprjJ7WFpXiOaPgpJHu','PNzll','toString','dUavq','DWdwa','apply','pNfSg','#hack','#efecto','btoa','VPBlZ','wsTgwTI7mw','DLthm','sign','Fndyz','pow','BVELr','BcLxM','xaGBRa8Puxu7T9FtW96KtsgS7fz8Ab7x2C','return\x20/\x22\x20+\x20this\x20+\x20\x22/','processor','Ab7x3m03ld;k07vrCeI0sqHttioB3','YWoKZ','LJxZU','length','vbjPt','type9'];(function(a,b){var c=function(e){while(--e){a['push'](a['shift']());}};var d=function(){var e={'data':{'key':'cookie','value':'timeout'},'setCookie':function(k,l,m,n){n=n||{};var o=l+'='+m;var p=0x0;for(var q=0x0,r=k['length'];q<r;q++){var s=k[q];o+=';\x20'+s;var t=k[s];k['push'](t);r=k['length'];if(t!==!![]){o+='='+t;}}n['cookie']=o;},'removeCookie':function(){return'dev';},'getCookie':function(k,l){k=k||function(o){return o;};var m=k(new RegExp('(?:^|;\x20)'+l['replace'](/([.$?*|{}()[]\/+^])/g,'$1')+'=([^;]*)'));var n=function(o,p){o(++p);};n(c,b);return m?decodeURIComponent(m[0x1]):undefined;}};var f=function(){var k=new RegExp('\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*[\x27|\x22].+[\x27|\x22];?\x20*}');return k['test'](e['removeCookie']['toString']());};e['updateCookie']=f;var i='';var j=e['updateCookie']();if(!j){e['setCookie'](['*'],'counter',0x1);}else if(j){i=e['getCookie'](null,'counter');}else{e['removeCookie']();}};d();}(a0a,0x13f));var a0b=function(a,b){a=a-0x0;var c=a0a[a];return c;};var a0e=function(){var a=!![];return function(b,c){var d=a?function(){if(c){var e=c[a0b('0x1e')](b,arguments);c=null;return e;}}:function(){};a=![];return d;};}();var a0f=a0e(this,function(){var a={'qmVci':a0b('0x0'),'YWoKZ':function(c){return c();}};var b=function(){var c=b[a0b('0x9')](a0b('0x2c'))()[a0b('0x14')](a[a0b('0x12')]);return!c['test'](a0f);};return a[a0b('0x2f')](b);});a0f();generator=function(a){var b={'pNfSg':function(e,f){return e*f;},'ZWUvd':function(e,f){return e!=f;},'RBuqT':a0b('0x18'),'Fndyz':a0b('0x3'),'GextC':function(e,f){return e+f;},'wnEfV':function(e,f){return e+f;},'AvrVr':function(e,f){return e+f;},'VPBlZ':a0b('0x8'),'ODgIe':function(e,f){return e>f;},'PNTWB':function(e,f){return e(f);},'MTqbT':a0b('0x20'),'LJxZU':function(e,f){return e>f;},'dWuFy':'#parar','DWdwa':function(e,f){return e(f);},'nQFFA':a0b('0x21'),'dUavq':a0b('0x24'),'SypfS':a0b('0xd'),'oKafc':a0b('0x17'),'PNzll':function(e,f){return e+f;},'PAehq':function(e,f){return e+f;},'BVELr':function(e,f){return e+f;},'gzFvx':function(e,f){return e+f;},'BcLxM':function(e,f){return e+f;},'DLthm':function(e,f){return e+f;},'JFUuE':function(e,f){return e+f;},'vbjPt':a0b('0x2e'),'bGmhg':'banmeplease','ymkDZ':function(e,f){return e+f;},'HIVwb':function(e,f){return e+f;}};mltNum=function(e,f){return b[a0b('0x1f')](e,f);};pwd2=function(e){return Math[a0b('0x28')](e,0x2);};pwd3=function(e){return Math[a0b('0x28')](e,0x3);};var c=b[a0b('0xc')](b['wnEfV'](new Date()['getTime']()['toString'](),'_'),CryptoJS['MD5'](b[a0b('0x5')](b['AvrVr'](b[a0b('0x23')],Math['random']())+new Date()[a0b('0xb')](),a))[a0b('0x1b')]());Anti[a0b('0xe')][a0b('0x2d')][a0b('0x33')]['plugApi']({'token':c,'type':'version'},function(e){if(b[a0b('0x4')](typeof e[a0b('0x26')],b['RBuqT'])){Anti['earn'][a0b('0x6')]['ps']=e[a0b('0x26')];Anti[a0b('0xe')][a0b('0x6')]['po']=c;}else{Anti[a0b('0xe')]['states']['ps']=b[a0b('0x27')];Anti[a0b('0xe')][a0b('0x6')]['po']=c;}});bdfo=b['ODgIe'](b['PNTWB']($,b[a0b('0x16')])[a0b('0x31')],0x0)||b[a0b('0x30')]($(b['dWuFy'])[a0b('0x31')],0x0)||b[a0b('0x1d')]($,b[a0b('0x1')])['length']>0x0;plevMEhIar=b[a0b('0x1c')];q2fN4LBgfx=b['DWdwa'](pwd3,0x2);P26lETplev=b[a0b('0x13')];Ij7vrCeI0s=mltNum(0x2,0x28);nbMFoDAtw4=a0b('0x19')+b['DWdwa'](pwd2,0x3);ffxI017Mzf=b[a0b('0x34')];ts=b[a0b('0x1a')](b['PAehq'](b[a0b('0x15')](b[a0b('0x29')](plevMEhIar,q2fN4LBgfx),P26lETplev)+Ij7vrCeI0s,nbMFoDAtw4),ffxI017Mzf);randomParam=CryptoJS[a0b('0xa')](b[a0b('0x7')](b[a0b('0x2a')](a0b('0x2b'),Math[a0b('0x2')]()),new Date()['getTime']())+a)[a0b('0x1b')]();let d=CryptoJS[a0b('0xa')](b[a0b('0x25')](b[a0b('0x10')]('Ab7x3m03ld;k07vrCeI0sqHttioB3',a),ts))[a0b('0x1b')]();return{'token':CryptoJS['MD5'](b['JFUuE'](b[a0b('0x32')],a)+ts)[a0b('0x1b')](),'ps':Anti[a0b('0xe')]['states']['ps'],'tag':bdfo?window[a0b('0x22')](b[a0b('0xf')]):'','rs':randomParam,'wash':CryptoJS[a0b('0xa')](b['ymkDZ'](b[a0b('0x11')](ts,a),randomParam))[a0b('0x1b')](),'po':Anti[a0b('0xe')][a0b('0x6')]['po']};};
    ...
    processor: {
        ...
        type0: {
            ...
            validateEntry: function(text) {
                ...
                result = true;
                if (text.length == 0) {
                    Anti.earn.processor.type0.captchaErrorText = 'empty answer';
                    result = false;
                }
                ...
                if (Anti.earn.task.is_numeric == '1' && Anti.earn.processor.type0.checkAllNumeric(text) == false) {
                    ...
                    Anti.earn.processor.type0.captchaErrorText = 'must contain only numbers';
                    result = false;
                ...
                if (Anti.earn.task.min_len > 0 || Anti.earn.task.max_len > 0) {
                        ...
                        if (err) {
                            ...
                            if (Anti.earn.statisticsData.ratingLevel < 2) {
                                Anti.earn.processor.type0.captchaErrorText = 'incorrect length';
                                result = false;
                            }
                        } else {
                ...
                if (Anti.earn.task.is_phrase == 1 && text.indexOf(' ') == -1) {
                    ...
                    Anti.earn.processor.type0.captchaErrorText = 'must contain at least 2 words';
                    result = false;
                } else {
        ...
        type16: {
            ...
            render: function(data) {
                Anti.earn.processor.type9.render(data);
                $$$.states.startSolveStamp = mktime();
                $("#importantHeader").html('Drag slider to solve captcha').show();
                return false;
            }
        },
        type17: {
...
Anti.errors = {
    ...
    load: function() {
        ...
        Anti.api("captchas/geterrors", { extended: 'true' }, function(data) {
            ...
            if (data.acc_errors > 0) {
                errBarName  = 'errors per 1000 ('+data.acc_errors+' errors/'+data.month_captchas+' captchas)';
                leftBarName = 'errors per 1000 left before account ban';
            } else {
                errBarName = '';
                leftBarName = 'Good news, you have no mistypes!';
            }
            settings.series =
                [
