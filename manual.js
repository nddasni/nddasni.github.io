...
function AntiFW(options){
    ...
    workflow: {
        ...
        requestNextTask: function() {
            ...
            Anti.earn.interface.setJobNameLabel('KBWORKING VIP MANUAL BY:KEIVIN GUEVARA');

            Anti.earn.interface.showLoaderMessage('KBWORKING VIP MANUAL BY:KEIVIN GUEVARA', '');
